...
from utils.data_handler import read_data_from_json, write_data_to_json
...
#initial data
listings_data = read_data_from_json(data_file_path)
...
def create_listing():
    ...
    write_data_to_json(listings_data, data_file_path)
